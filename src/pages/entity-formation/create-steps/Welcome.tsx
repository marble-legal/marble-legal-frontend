  ...
  return (
    <div className="w-full h-full items-center justify-center flex flex-col max-w-[540px] mx-auto">
      ...
      <p className="text-[1rem] font-[400] leading-[150%]">
        ...
        will be held in strict confidence. <br /> When filling out this Intake
        Form please use full legal names and make sure that the names of any
        party or entity listed are spelled correctly. If more space is needed,
        please feel free to attach additional pages as necessary. If you are
        unsure about how to answer some of the questions, simply indicate on the
        form that you would like to discuss the subject matter at our initial
        consultation.
      </p>
